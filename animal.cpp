...
Animal::Animal(const int id, const QString& name, const QString &type, const QString &breed, const QString &age, const QString &gender,
               ...
               const QString &source,const QString &exercise, const QString &skills, const QString &learning, const QString &space, const QString &fee):
        ...
        _source(source), _exercise(exercise), _skills(skills), _learning(learning), _space(space), _fee(fee)
{
