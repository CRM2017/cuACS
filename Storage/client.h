...
public:
    Client(const QString &id, const QString &name, const QString &phone, const QString &email,
           ...
           const QString &Animalexercise, const QString &Animalskills, const QString &Animallearning, const QString &Animalspace, const QString &Animalfee, const QString &PriorAttribute1, const QString &PriorAttribute2, const QString &PriorAttribute3, const QString &PriorAttribute4, const QString &PriorAttribute5);
    ~Client();
    QString getId() const;
